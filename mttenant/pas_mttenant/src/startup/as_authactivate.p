...
if not connected("mttenant") then do:
    connect -db mttenant -H db_mttenant -S 37000.
end. 
...
assign hCP = session:current-request-info:GetClientPrincipal() .
message tenant-id("mttenant").
message hCP:tenant-name.
